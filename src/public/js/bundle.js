...
var Constants = /** @class */ (function () {
    ...
    Constants.generateId = function () {
        return "".concat((0, uuid_1.v4)()).concat((0, uuid_1.v4)());
    };
    Constants.BIO_ID = 'bio';
    Constants.PASSWORD_ID = 'password';
    Constants.PASSWORD_MIN_LENGHT = 8;
    Constants.EMAIL_ID = 'email';
    Constants.EMAIL_MAX_LENGHT = 80;
    Constants.LAST_NAME_ID = 'lastName';
    Constants.LAST_NAME_MAX_LENGHT = 50;
    Constants.LAST_NAME_MIN_LENGHT = 2;
    Constants.BIO_MAX_LENGHT = 150;
    Constants.NAME_ID = 'name';
    Constants.NAME_MAX_LENGHT = 30;
    Constants.NAME_MIN_LENGHT = 2;
    Constants.MAX_LENGHT_DEFAULT = 80;
    Constants.SIGN_IN_URL = '/account/signin';
    return Constants;
}());
...
var setSmallMessage = function (element, txt, show) {
    var _a;
    if (show === void 0) { show = false; }
    var small = (_a = element.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('.small');
    if (small) {
        if (txt)
            small.innerHTML = txt;
        if (show)
            small.classList.remove('d-none');
        else if (!small.classList.contains('d-none'))
            small.classList.add('d-none');
    }
};
var maxLen = function (event, input, max, small) {
    ...
    if (small)
        setSmallMessage(input, (max - target.value.length).toString(), true);
};
var minLen = function (event, input, min) {
    var target = event.target;
    if (target.value.length < min)
        setSmallMessage(input, null, true);
    else
        setSmallMessage(input, null, false);
};
var setEmailValidation = function (input) {
    input.addEventListener('input', function (event) {
        var error = false;
        var value = event.target.value;
        var arr = value.split('');
        var obj = { at: arr.includes('@'), dot: arr.includes('.') };
        var afterAt = value.split('@')[1];
        ...
        if (error)
            ...
            setSmallMessage(input);
    });
};
var action = function (input, id) {
    var setMaxLenght = function (max, small) {
        if (small === void 0) { small = false; }
        input.addEventListener('input', function (event) { return maxLen(event, input, max, small); });
    };
    var setMinLenght = function (min) {
        input.addEventListener('input', function (event) { return minLen(event, input, min); });
    };
    var setMaxAndMinLenght = function (max, min) {
        input.addEventListener('input', function (event) {
    ...
    switch (input.id) {
        case Constants_1.default.BIO_ID:
            setMaxLenght(Constants_1.default.BIO_MAX_LENGHT, true);
            break;
        case Constants_1.default.NAME_ID:
            setMaxAndMinLenght(Constants_1.default.NAME_MAX_LENGHT, Constants_1.default.NAME_MIN_LENGHT);
            break;
        case Constants_1.default.LAST_NAME_ID:
            setMaxAndMinLenght(Constants_1.default.LAST_NAME_MAX_LENGHT, Constants_1.default.LAST_NAME_MIN_LENGHT);
            break;
        case Constants_1.default.EMAIL_ID:
            setEmailValidation(input);
            break;
        case Constants_1.default.PASSWORD_ID:
            setMinLenght(Constants_1.default.PASSWORD_MIN_LENGHT);
            break;
        default:
            setMaxLenght(Constants_1.default.MAX_LENGHT_DEFAULT);
            break;
    }
};
...
var formValidation = function (form) {
    ...
    var elements = __spreadArray(__spreadArray([], Array.from(inputs), true), Array.from(textareas), true);
    form.addEventListener('submit', formSubmit);
    elements.forEach(function (element) {
        var id = Constants_1.default.generateId();
        action(element, id);
    });
};
